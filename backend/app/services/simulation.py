...
SCENARIOS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "description": "No occupant complaint is attached. The building monitor detected a sustained abnormal air-quality reading in the engineering pantry.",
        "requester": "Building Monitoring",
        "location_id": "BLDG-A-F06-PANTRY",
