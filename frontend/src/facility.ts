...
export const floors: FloorRecord[] = [
  ...
  { number: 5, name: "Product & Design", use: "Hybrid workplace", occupancy: 43, capacity: 64, area: "18,400 sq ft", status: "Normal", openTickets: 0, rooms: ["Design studio", "Product east", "Pantry", "Meeting 5D"] },
