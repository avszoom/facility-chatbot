...
class BuildingPort(Protocol):
    ...
    def complete_incident_repair(self, asset_id: str, ticket_id: str | None = None) -> dict[str, Any]: ...
    def verify(self, ticket: Ticket) -> dict[str, Any]: ...
    def set_verification_failure(self, ticket_id: str, enabled: bool) -> None: ...
    def inject_simulated_condition(self, condition: str, location_id: str = "BLDG-A", ticket_id: str | None = None) -> dict[str, Any]: ...
